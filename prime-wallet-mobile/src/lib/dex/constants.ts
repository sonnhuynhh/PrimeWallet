...
/** Token list cho Ethereum mainnet (LI.FI aggregator). */
export const MAINNET_TOKENS: DexToken[] = [
  { address: NATIVE_SENTINEL, symbol: "ETH", name: "Ethereum", decimals: 18, isNative: true },
  {
...
export function tokensForChain(chainId: number | undefined): DexToken[] {
  if (chainId === AGGREGATOR_CHAIN_ID) return MAINNET_TOKENS;
